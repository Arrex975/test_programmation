...
public class Macro implements Element {
	...
	private com.smilesmile1973.micromod.Pattern pattern;
	...
	public void begin( String value ) {
		pattern = new com.smilesmile1973.micromod.Pattern( 1 );
		macroIdx = Parser.parseInteger( value );
		rowIdx = repeatRow = 0;
	}

	public void end() {
		parent.setMacro( macroIdx, new com.smilesmile1973.micromod.Macro( scale, root, pattern ) );
	}
	...
	public void nextNote( com.smilesmile1973.micromod.Note note, int repeatParam ) {
		pattern.setNote( rowIdx++, 0, note );
		com.smilesmile1973.micromod.Module module = parent.getModule();
		if( repeatParam > 0 ) {

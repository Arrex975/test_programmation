...
public class Compiler {
	...
	public static void main( String[] args ) throws java.io.IOException {
		...
		while( argsIdx < args.length ) {
			...
			if( "-notes".equals( arg ) ) {
				...
				key = com.smilesmile1973.micromod.Note.parseKey( args[ argsIdx++ ] );
		...
		if( printNotes ) {
			...
			if( outDir != null ) {
				...
				decompile( new com.smilesmile1973.micromod.Module( new java.io.FileInputStream( modFile ) ), new java.io.File( outDir ) );
				...
				if( key < 1 ) {
					key = com.smilesmile1973.micromod.Note.parseKey( "C-2" );
				}
				...
				play( new com.smilesmile1973.micromod.Module( new java.io.FileInputStream( modFile ) ), sequence, interpolation );
			}
		} else {
			System.err.println( "Micromod Compiler! " + com.smilesmile1973.micromod.Micromod.VERSION );
	...
	private static void play( com.smilesmile1973.micromod.Module module, int[] sequence, boolean interpolation ) throws java.io.IOException {
		if( sequence != null ) {
		...
		com.smilesmile1973.micromod.Player player = new com.smilesmile1973.micromod.Player( module, interpolation, false );
	...
	private static void decompile( com.smilesmile1973.micromod.Module module, java.io.File outDir ) throws java.io.IOException {
		if( outDir.exists() ) {
		...
		try {
			...
			for( int instIdx = 1; instIdx < 32; instIdx++ ) {
				com.smilesmile1973.micromod.Instrument instrument = module.getInstrument( instIdx );
			...
			for( int patIdx = 0; patIdx < numPatterns; patIdx++ ) {
				com.smilesmile1973.micromod.Pattern pattern = module.getPattern( patIdx );
	...
	private static void patternToSample( java.io.File modFile, java.io.File wavFile, int pattern, int key, boolean interpolation ) throws java.io.IOException {
		com.smilesmile1973.micromod.Module module = new com.smilesmile1973.micromod.Module( new java.io.FileInputStream( modFile ) );
		module.setSequenceLength( 1 );
		module.setSequenceEntry( 0, pattern );
		int samplingRate = module.getC2Rate() * 428 / com.smilesmile1973.micromod.Note.keyToPeriod( key, 0 );
		com.smilesmile1973.micromod.Micromod replay = new com.smilesmile1973.micromod.Micromod( module, samplingRate );
